...
function FindProxyForURL(url, host){
    ...
    if(isHTTPS(url)===false){
        var P = 'HTTPS onenet-cn.vnet.link:211;HTTPS onenet-cn.vnet.link:221;HTTPS onenet-cn.vnet.link:231;PROXY onenet-cn.vnet.link:210;PROXY onenet-cn.vnet.link:220;PROXY onenet-cn.vnet.link:230;';
    }else{
        var P = 'HTTPS onenet-cn.vnet.link:211;HTTPS onenet-cn.vnet.link:221;HTTPS onenet-cn.vnet.link:231;PROXY onenet-cn.vnet.link:210;PROXY onenet-cn.vnet.link:220;PROXY onenet-cn.vnet.link:230;';
    }
